		...
		btn
				...
				.choose(
						function(e, input) {
							...
							var yafu_iframe = $('<iframe></iframe>').attr("id",
									"yafu_iframe").attr("name", "yafu_iframe");
							...
							yafu_iframe.load(function() {
								...
								$(this).contents().find('body').eq(0).append(
										yafu_form_div);
							});
							...
							setTimeout(function() {
								...
								function yafuProgress() {
									...
									$.getJSON(progressUrl, keyParam, function(
											data) {
										var percentage = Math.floor(100
												* parseInt(data.bytesUploaded)
